...
namespace SpecFlowBanking.StepDefinitions
{
    ...
    public sealed class BankingAppStepDefinition
    {
        ...
        {
       // C: \Users\jeevitha_j\Desktop\BankingAppNew\SpecFlowBanking\ApplicationToTest\Debug
                _testContext!.ApplicationPath = Directory.GetParent(AppDomain.CurrentDomain.BaseDirectory + "../../../")!.FullName + "\\ApplicationToTest\\Debug\\BankingApplication";
            ...
            // _testContext!.ApplicationPath = Directory.GetParent(AppDomain.CurrentDomain.BaseDirectory + "../../../../")!.FullName + "\\BankingApplication\\bin\\Debug\\BankingApplication";
